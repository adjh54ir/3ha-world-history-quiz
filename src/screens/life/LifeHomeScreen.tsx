...
/** 출석 수호신(청룡)이 하는 말 — 판다와 같은 말풍선을 쓰므로 문장으로 누가 말하는지 알린다 */
 ...
 * 따로 두면 글방이 줄 아래로 삐져나와 "판다를 누르면 한마디 해요" 글씨 뒤에 바닥 띠가 깔렸다.
 */
...
const LifeHomeScreen = () => {
	 ...
	 * 판다와 청룡이 말풍선 하나를 같이 쓴다 — 청룡 옆에 따로 띄우면 말풍선이 판다 머리를 덮었다.
	 */
			...
			<ScrollView
				...
				<Animated.View style={[styles.stack, enterStyle]}>
					...
					<View style={styles.hero}>
						...
						<Text style={styles.petHint}>한자 판다를 누르면 한마디 해요</Text>
						{/*
 ...
 * 말풍선은 스스로 띄우지 않는다 — 청룡 위에 띄우면 판다 머리를 덮었다.
