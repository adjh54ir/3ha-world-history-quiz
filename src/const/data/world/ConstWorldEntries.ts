 ...
 *              242개 가운데 84개는 설명을 출처에서 기계로 뽑아 썼다
 *              (설명이 "…에 있으며 수도는 …다." 꼴이면 그 항목이다 — 곁가지는 나중에 손으로 다시 썼다).
 *              나머지 158개는 설명도 손으로 썼다.
 ...
 * - nature   : 지형 48개. 그림이 없다 — 강·산맥은 사진 한 장으로 가려낼 수 있는 대상이 아니다.
 *              나라는 **그 안에 온전히 들어 있을 때만** 적는다 (48개 가운데 17개). 나일강(11개국)·알프스산맥처럼
 *              여러 나라에 걸친 것은 비워 둔다. 비우면 '어느 나라' 문항만 안 나온다.
 *              처음 20개는 등급마다 3~7개뿐이라 한 판(10문항)이 안 나왔다. 30개를 보태 등급을 10·12·14·12 로 폈다.
 *              랜드마크에 이미 있는 것은 넣지 않는다 — 그랜드캐니언·울루루·앙헬 폭포·그레이트배리어리프는
 *              사진으로 먼저 아는 곳이어서 그쪽에 두고, 여기서는 콜로라도강·아마존 열대우림처럼 지도로 아는 것을 넣었다.
 * - event    : 사건 119개. 그림이 없는 주제다 (사건 사진은 저작권이 남아 있는 것이 대부분이라 아예 안 쓴다).
 ...
 *              문명처럼 세기로 끊기 어려운 것만 "기원전 3500년 무렵" 꼴로 적는다.
 *              `kind` 는 열한 갈래로 못 박아 뒀다 (전쟁·건국·제도·혁명·사상·조약·재난·발명·탐험·문명·멸망).
 *              갈래를 늘리면 '무슨 일인가' 문항의 보기가 흐려진다 — 새 항목도 이 안에서 고른다.
