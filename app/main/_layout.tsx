...
export default function MainTabLayout() {
	...
	return (
		<Tabs
			...
			<Tabs.Screen name={Paths.WORDS} options={{ title: '사전', tabBarIcon: tabBarIcon('book-search-outline', 'book-search') }} />
			<Tabs.Screen name={Paths.TODAY} options={{ title: '오늘', tabBarIcon: tabBarIcon('calendar-star', 'calendar-star') }} />
			<Tabs.Screen name={Paths.HOME} options={{ title: '홈', tabBarIcon: tabBarIcon('home-outline', 'home') }} />
			<Tabs.Screen name={Paths.PROFILE} options={{ title: '나의 활동', tabBarIcon: tabBarIcon('chart-box-outline', 'chart-box') }} />
			<Tabs.Screen name={Paths.STATS} options={{ title: '통계', tabBarIcon: tabBarIcon('chart-line-variant', 'chart-line') }} />
			<Tabs.Screen name={Paths.SETTING} options={{ title: '설정', tabBarIcon: tabBarIcon('cog-outline', 'cog') }} />
		</Tabs>
	);
}
